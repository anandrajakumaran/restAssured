...
package com.rest.test.restAssured.logging;
...
public final class AppLogger {
    ...
    private static SimpleLoggerSettings getDefaultLoggerSettings(){
        ...
        settings.setUserLogFileName("restAssured.log");
        settings.setDeveloperLogFileName("restAssured-detailed.log");
        settings.setIdentifier("0.0.1-SNAPSHOT");
